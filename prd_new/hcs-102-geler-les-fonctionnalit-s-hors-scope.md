---
title: "[HCS-102] Geler les fonctionnalités hors scope"
...
# [HCS-102] Geler les fonctionnalités hors scope

## 🎯 Objectif

Établir un scope freeze pour empêcher l'ajout de fonctionnalités non nécessaires à la beta.
...
- [ ] Une liste explicite OUT OF SCOPE existe.
- [ ] Toute nouvelle idée est envoyée au backlog.
- [ ] Aucune issue hors phase active ne bloque une issue P1.
- [ ] Le scope freeze est référencé dans la roadmap.
