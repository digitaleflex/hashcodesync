---
title: "[HCS-103] Définir la frontière PUBLIC / INTERNAL"
labels: ["p1", "security", "phase-0"]
priority: "P1"
deadline: "2026-09-08"
status: "TODO"
---

# [HCS-103] Définir la frontière PUBLIC / INTERNAL

## 🎯 Objectif

Définir précisément quelles données et fonctionnalités sont accessibles publiquement et lesquelles restent internes.
...
- [ ] Une matrice PUBLIC/INTERNAL est documentée.
- [ ] Les disponibilités individuelles sont INTERNAL.
- [ ] Les données de groupes internes sont INTERNAL.
- [ ] Les activités publiques n'exposent que les champs autorisés.
- [ ] Les règles sont utilisées par les routes et contrôles d'accès.
