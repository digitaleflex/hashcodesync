---
title: "[HCS-104] Valider l'architecture de navigation"
labels: ["p1", "architecture", "phase-0"]
priority: "P1"
deadline: "2026-09-08"
status: "TODO"
---

# [HCS-104] Valider l'architecture de navigation

## 🎯 Objectif

Valider la séparation des espaces public, membre, mentor et administration.
...
- [ ] Les route groups sont documentés.
- [ ] /program/* est identifié comme espace public.
- [ ] /dashboard/* reste authentifié.
- [ ] /mentor/* applique les rôles mentor/admin.
- [ ] /admin/* applique le rôle admin.
