---
title: "[HCS-201] Concevoir le modèle de données public"
labels: ["p1", "architecture", "phase-2"]
priority: "P1"
deadline: "2026-09-12"
status: "TODO"
---

# [HCS-201] Concevoir le modèle de données public

## 🎯 Objectif

Définir le modèle de publication des activités sans créer de duplication inutile.
...
- [ ] Les champs lifecycle sont définis.
- [ ] Les champs de visibilité sont définis.
- [ ] Les champs publics sont explicitement séparés des données internes.
- [ ] La migration est rétrocompatible avec les données existantes.
- [ ] Les règles d'accès sont documentées.
