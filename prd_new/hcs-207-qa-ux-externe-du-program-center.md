---
title: "[HCS-207] QA UX externe du Program Center"
labels: ["p1", "qa", "phase-2"]
priority: "P1"
deadline: "2026-09-17"
status: "TODO"
---

# [HCS-207] QA UX externe du Program Center

## 🎯 Objectif

Valider qu'un visiteur externe comprend et utilise le Program Center sans assistance.
...
- [ ] Un parcours visiteur complet est testé.
- [ ] Les principaux états vides/erreurs sont vérifiés.
- [ ] Mobile et desktop sont testés.
- [ ] Les problèmes P1/P2 sont enregistrés.
- [ ] Les corrections critiques sont appliquées avant le gate.
