---
title: "[HCS-306] Tests d'isolation PUBLIC / INTERNAL"
...
# [HCS-306] Tests d'isolation PUBLIC / INTERNAL

## 🎯 Objectif

Tester systématiquement l'absence d'exposition de données internes.
...
- [ ] Les réponses API sont inspectées.
- [ ] Les données de disponibilité ne sont jamais exposées.
- [ ] Les membres internes ne sont pas exposés.
- [ ] Les régressions sont détectables par tests.
