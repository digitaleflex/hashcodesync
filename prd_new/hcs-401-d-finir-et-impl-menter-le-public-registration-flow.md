---
title: "[HCS-401] Définir et implémenter le Public Registration Flow"
labels: ["p1", "product", "phase-3"]
priority: "P1"
deadline: "2026-09-20"
status: "TODO"
---

# [HCS-401] Définir et implémenter le Public Registration Flow

## 🎯 Objectif

Permettre le parcours Discover → Details → Register → Auth/Create Account → Confirm.
...
- [ ] Le parcours est documenté.
- [ ] Les visiteurs non connectés sont gérés.
- [ ] Le compte est créé ou réutilisé correctement.
- [ ] La confirmation est claire.
- [ ] Les échecs ne créent pas d'inscription incohérente.
