---
title: "[HCS-404] Intégrer Auth / Create Account"
labels: ["p1", "auth", "phase-3"]
priority: "P1"
deadline: "2026-09-21"
status: "TODO"
---

# [HCS-404] Intégrer Auth / Create Account

## 🎯 Objectif

Relier l'inscription publique à Better Auth sans dupliquer les identités.
...
- [ ] Un nouveau visiteur peut créer un compte.
- [ ] Le retour vers l'activité est préservé.
- [ ] La vérification email suit les règles du système.
- [ ] Les sessions respectent les protections existantes.
