---
title: "[HCS-501] Audit public data boundary"
labels: ["p1", "security", "phase-1"]
priority: "P1"
deadline: "2026-09-08"
status: "TODO"
---

# [HCS-501] Audit public data boundary

## 🎯 Objectif

Auditer les routes, queries et sérialisations afin d'empêcher toute fuite de données INTERNAL.
...
- [ ] Chaque endpoint public est inventorié.
- [ ] Les champs sensibles sont exclus des réponses publiques.
- [ ] Les tests confirment l'absence de données privées.
- [ ] Les accès non autorisés retournent une réponse sûre.
- [ ] Les findings critiques sont corrigés avant Phase 2.
