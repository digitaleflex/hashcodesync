---
title: "[HCS-505] Ajouter health checks et monitoring minimal"
labels: ["p1", "observability", "phase-1"]
priority: "P1"
deadline: "2026-09-11"
status: "TODO"
---

# [HCS-505] Ajouter health checks et monitoring minimal

## 🎯 Objectif

Mettre en place un niveau minimal d'observabilité avant la beta.
...
- [ ] Un health check applicatif existe.
- [ ] La disponibilité de la base est vérifiée de manière appropriée.
- [ ] Les erreurs critiques sont journalisées.
- [ ] Les informations sensibles ne sont pas exposées.
- [ ] La procédure de vérification est documentée.
